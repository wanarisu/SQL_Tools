...
exports.rebuildNativeModules = exports.rebuild = exports.createOptions = void 0;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((modulePackageJson.dependencies || {})['prebuild-install']) {
                ...
                if (prebuildInstallPath) {
                    ...
                    try {
                        yield cross_spawn_promise_1.spawn(executable, [
            ...
            yield cross_spawn_promise_1.spawn(nodeGypPath, rebuildArgs, {
                cwd: modulePath,
